...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/stefan-karlsson/LocalEnvVar">View Demo</a>
    &middot;
...
2. Clone the repo
   ```sh
   git clone https://github.com/stefan-karlsson/LocalEnvVar.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin stefan-karlsson/LocalEnvVar
...
See the [open issues](https://github.com/stefan-karlsson/LocalEnvVar/issues) for a full list of proposed features (and known issues).
...
[license-url]: https://github.com/stefan-karlsson/LocalEnvVar/blob/master/LICENSE.txt
